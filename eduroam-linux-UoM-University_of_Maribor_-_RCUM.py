...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "University of Maribor"
Config.profilename = "University of Maribor - RCUM"
Config.url = "https://it.um.si"
Config.email = "noc@um.si"
Config.title = "eduroam CAT"
Config.server_match = "sfinga.um.si"
...
Config.user_realm = "um.si"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:sfinga.um.si']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@um.si"
Config.tou = ""
